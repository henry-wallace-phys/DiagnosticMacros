...
for k in "${!STUDIES[@]}"; do
    ...
    root -l -b -q 'scripts/plot_diag_comp.C("'${nova_adapt_file}${diag_suffix}'", "NOvA Adapt", "'${nova_no_adapt_file}${diag_suffix}'", "NOvA No Adapt", "plots/nova_adapt_no_adapt_diag_comp_'${STU}'")'
    root -l -b -q 'scripts/plot_diag_comp.C("'${t2k_adapt_file}${diag_suffix}'", "T2K Adapt", "'${t2k_no_adapt_file}${diag_suffix}'", "T2K No Adapt", "plots/t2k_adapt_no_adapt_diag_comp_'${STU}'")'
    root -l -b -q 'scripts/plot_diag_comp.C("'${nova_adapt_file}${diag_suffix}'", "NOvA Adapt", "'${t2k_adapt_file}${diag_suffix}'", "T2K Adapt", "plots/nova_t2k_adapt_diag_comp_'${STU}'")'
    root -l -b -q 'scripts/plot_diag_comp.C("'${nova_no_adapt_file}${diag_suffix}'", "NOvA No Adapt", "'${t2k_no_adapt_file}${diag_suffix}'", "T2K No Adapt", "plots/nova_t2k_no_adapt_diag_comp_'${STU}'")'
